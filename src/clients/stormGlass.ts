...
export class StormGlass {
  ...
  public async fetchPoints(lat: number, lng: number): Promise<ForecastPoint[]> {
    ...
    const response = await this.request.get<StormGlassForecastResponse>(
      `https://api.stormglass.io/v2/weather/point?lat=${lat}&lng=${lng}&params=${params}&source=${this.stormGlassAPISource}&end=${timestampUTC}`,
      {
        headers: {
          Authorization:
            'fe8e5534-e00d-11ef-9159-0242ac130003-fe8e55de-e00d-11ef-9159-0242ac130003',
        },
      }
    );
